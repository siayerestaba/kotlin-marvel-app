...
{
    fun bind(marvelSuperHeroe: MarvelSuperHeroe) {
    ...
    private fun setListeners(marvelSuperHeroe: MarvelSuperHeroe) {
        containerView.setOnClickListener { presenter.onSuperHeroClicked(marvelSuperHeroe) }
    }
}